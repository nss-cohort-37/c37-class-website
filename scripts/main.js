...
function cohortMembers(list) {
  ...
  data.forEach(function (item) {
    ...
    let studentInfo = `<div class="col-lg-3 cohortMems">
          <img class="card-img-top" src="images/classmates/${item.proImg}" alt="${item.firstName} ${item.lastName}" data-toggle="modal" data-target="#cohortMember${item.id}";">
          <div class="card-body">
